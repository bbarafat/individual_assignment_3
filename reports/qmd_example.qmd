...
(Government of Canada, 2017a and Government of Canada, 2017b)[@horses1; @horses2].
...
![](../results/horse_pops_plot.png){#fig-horse width=70%}

@fig-horse: Horse populations for all provinces in Canada from 1906 - 1972.
...
@tbl-standard-dev. Standard deviation of historical (1906-1972) horse populations for each Canadian province.

```{python}
#| label: tbl-standard-dev
#| tbl-cap: Provinces and their spreads
...
Additionally, note that in @tbl-standard-dev we consider the sample standard deviation of the number of horses during the same time span as @fig-horse.

![](../results/horse_pops_plot_largest_sd.png){#fig-sd width=70%}

@fig-sd: Horse populations for the province with the largest standard deviation
